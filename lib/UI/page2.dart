...
class page2 extends StatefulWidget {
  ...
  const page2({Key? key,required this.username}) : super(key: key);
...
class _page2State extends State<page2> {
  ...
  @override
  void initState() {
    BlocProvider.of<InstaBloc>(context).add(FetchInsta(message: widget.username));
    super.initState();
  }
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Row(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Icon(Icons.person_add_alt,color: Colors.white,size: 20.sp,)
                                    ],
                                  ),
                                ),
                              ),
                    ...
                    SizedBox(height: 160*response.edgeOwnerToTimelineMedia!.edges!. length/3,
                      child: TabBarView(
